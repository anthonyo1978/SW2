...
export function MetricsGrid({ organizationId }: MetricsGridProps) {
  ...
  const metrics = [
    ...
    },
    {
      ...
      icon: FileText,
      color: stats.pendingInvoices > 10 ? "text-red-600" : "text-yellow-600",
      bgColor: stats.pendingInvoices > 10 ? "bg-red-50" : "bg-yellow-50",
      badge: stats.pendingInvoices > 10 ? "Attention Needed" : "Normal",
      badgeColor: stats.pendingInvoices > 10 ? "bg-red-100 text-red-800" : "bg-yellow-100 text-yellow-800",
    },
    {
      title: "Completed Visits",
      value: stats.completedVisits,
      description: "98% Documentation complete",
      icon: CheckCircle,
      color: "text-green-600",
      bgColor: "bg-green-50",
      badge: "Audit Ready",
